...
// CONCATENATED MODULE: ./src/components/Layout/Bootstrap.js
...
const BootstrapJs = () => __jsx(external_react_default.a.Fragment, null, __jsx("script", {
...
class _document_MyDocument extends document_default.a {
  render() {
    return _document_jsx("html", null, _document_jsx(next_document["Head"], null, _document_jsx("link", {
      rel: "icon",
      type: "image/png",
      ...
      rel: "stylesheet",
      type: "text/css"
    }), _document_jsx(BootstrapCss, null), _document_jsx("link", {
      rel: "stylesheet",
    ...
    })), _document_jsx("body", null, _document_jsx(next_document["Main"], null), _document_jsx(next_document["NextScript"], null), _document_jsx(BootstrapJs, null)));
  }
