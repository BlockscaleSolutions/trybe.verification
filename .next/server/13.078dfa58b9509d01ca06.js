...
module.exports = {
	...
	"renderer-loader": "_3BJ-HyRa-FDcN1E5RHi0k6"
};
...
class CertificateSharingForm extends react__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  handleSend() {
    ...
    if (emailSendingState !== _reducers_certificate__WEBPACK_IMPORTED_MODULE_4__[/* states */ "x"].PENDING) {
      handleSendCertificate({
  ...
  render() {
    ...
    })), emailSendingState === _reducers_certificate__WEBPACK_IMPORTED_MODULE_4__[/* states */ "x"].SUCCESS ? __jsx("div", {
      className: "row my-4 d-flex justify-content-center"
    }, "Email successfully sent!") : "", emailSendingState === _reducers_certificate__WEBPACK_IMPORTED_MODULE_4__[/* states */ "x"].FAILURE ? __jsx("div", {
      className: "row my-4 d-flex justify-content-center"
    ...
    }, "Send", emailSendingState === _reducers_certificate__WEBPACK_IMPORTED_MODULE_4__[/* states */ "x"].PENDING ? __jsx("i", {
